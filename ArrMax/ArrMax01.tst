...
set local[0] 14,   // local 0
set local[1] 8,   // local 1
set local[2] 23,   // local 2

set argument[0] 42,  // argument 0
set argument[1] 19,  // argument 1
set argument[2] 0,  // argument 2

set RAM[2048] 14,  // Set Arr[0]
set RAM[2049] 8,  // Set Arr[1]
set RAM[2050] 23,  // Set Arr[2]
set RAM[2051] 42;  // Set Arr[3]
set RAM[2052] 19;  // Set Arr[4]
